...
This guide provides a complete, step-by-step walkthrough to test the end-to-end functionality of the EcoTrace platform. The system is divided into three key roles: **Admin**, **Driver**, and **Plant Manager**.
...
2. Log in using the **Plant Head** credentials (`admin@ecotrace.in` / `admin123`).
...
1. Log in using the **Driver** credentials (`driver1@ecotrace.in` / `driver123`).
2. **Start Route:**
...
1. Log in using the **Manager** credentials (`manager@ecotrace.in` / `manager123`).
